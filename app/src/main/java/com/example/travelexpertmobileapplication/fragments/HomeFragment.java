        ...
        linearLayout_Customers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                blink.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        //Loading the fragment
                        Fragment modernCustomerFragment = new ModernCustomerFragment();
                        //Fragment customerFragment = new CustomerFragment();
                        FragmentTransaction transaction = getParentFragmentManager().beginTransaction();
                        //transaction.replace(R.id.fragment_container, customerFragment);
                        transaction.replace(R.id.fragment_container, modernCustomerFragment);
                        transaction.addToBackStack(null);
                        transaction.commit();
                    }
            ...
            public void onClick(View v) {
                ...
                blink.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        ...
                        Fragment modernSupplierFragment = new ModernSupplierFragment();
                        FragmentTransaction transaction = getParentFragmentManager().beginTransaction();
                        transaction.replace(R.id.fragment_container, modernSupplierFragment);
        ...
        call.enqueue(new Callback<>() {
            ...
            public void onResponse(Call<GenericApiResponse<AgentDetailsResponseDTO>> call, Response<GenericApiResponse<AgentDetailsResponseDTO>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    callImage.enqueue(new Callback<GenericApiResponse<AgentImageResponseDTO>>() {
                        @Override
